  ...
  return (
    <section className="w-full h-screen bg-background text-foreground font-mono  ">
      <div className="w-full  h-full flex flex-col justify-center items-center my-auto gap-4">
        ...
        <p className="text-lg max-w-lg text-balance text-center leading-loose  rounded-mdd px-4 py-2 text-[#888888] ">
          One stop to convert
          <Link
            href={"/svg-to-png"}
            className="bg-syntax-string py-px px-1 text-background rounded-mdd ml-1  transform hover:-rotate-6 inline-block transition-all duration-300"
          >
            SVG to PNG
          </Link>
          , JPG, WEBP.
